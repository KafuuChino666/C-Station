...
CREATE TABLE b_black_room(
	black_room_id INT unsigned PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE b_ban_info(
	ban_info_id INT unsigned PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE b_ban_cause(
	ban_cause_id INT unsigned PRIMARY KEY AUTO_INCREMENT,
